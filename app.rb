...
class GitHubExtension
  ...
  def handle_get_repository(payload, _context)
  ...
  def handle_sync_pull_request(payload, _context)
  ...
  def handle_get_pull_request(payload, _context)
    repo_key = "#{payload['owner']}/#{payload['name']}"
  ...
  def handle_webhook(payload, context)
    ...
    verify_webhook_signature(raw_payload, signature, webhook_secret) if webhook_secret && signature
  ...
  def handle_list_branches(payload, _context)
    repo_key = "#{payload['owner']}/#{payload['name']}"
    repo = @repositories[repo_key]
  ...
  def handle_list_tags(payload, _context)
    repo_key = "#{payload['owner']}/#{payload['name']}"
    repo = @repositories[repo_key]
  ...
  def handle_pr_metrics(payload, _context)
    repo_key = payload['repository']
  ...
  def handle_issue_metrics(payload, _context)
    repo_key = payload['repository']
  ...
  def handle_export_pull_requests(payload, _context)
    repo_key = payload['repository']
  ...
  def handle_issue_event(data)
    ...
    nil unless @repositories[repo_key][:sync_issues]
  ...
  def handle_issue_comment_event(data)
    ...
    nil unless @repositories[repo_key]
  ...
  def handle_push_event(data)
    ...
    nil unless @repositories[repo_key][:auto_link]

    # Would extract issue references from commit messages here
  end

  def handle_ref_event(data, _event_type)
    repo = data['repository']
    repo_key = repo['full_name']
  ...
  def verify_webhook_signature(payload, signature, secret)
    ...
    return if Rack::Utils.secure_compare(computed_signature, signature)
